        ...
        while (i < result) {
            ...
            contractInstance.CheckCandidate(i, function (error2, result2) {
                ...
                if ($("#votedFlg").val() === "true") {
                    ...
                    //    vote(this.id);
                    //});
                    $('#candidate' + result2[0]).on("click", function () { vote(this.id); });
                }
            });
